...
export const LANDING_TOUR_STEPS: TourStep[] = [
  {
    ...
    tag: "01 // WELCOME",
    title: "LISTEN & FIX",
    body: "Welcome to the advanced diagnostics platform. Upload or record a fault sound from any mechanical equipment and get a full repair blueprint in under 60 seconds.",
  ...
  },
  {
    ...
    body: "The Diagnostic Stream panel on this page shows a live simulation of the 6-stage diagnostic pipeline. In real mode it processes your audio, video, or image, then cross-references 50,000+ OEM manuals to identify the exact fault.",
  ...
  },
  {
    ...
    body: "CAPTURE your equipment's fault sound or image. It will ANALYZE the acoustic signature and pinpoint the root cause. Then REPAIR with a step-by-step guide tailored to your exact hardware configuration.",
  },
  {
    icon: <Play size={24} />,
    tag: "04 // GET STARTED",
...
export const DASHBOARD_TOUR_STEPS: TourStep[] = [
  {
    ...
    body: "You are now inside the diagnostic command center. This dashboard runs a 6-stage pipeline that analyzes your equipment faults and produces a full repair blueprint.",
    highlight: "PIPELINE_STATUS: ONLINE // All pipeline stages nominal.",
  },
  {
    icon: <Play size={24} />,
  ...
  },
  {
    ...
    body: "After uploading, the 6-stage pipeline runs automatically. Watch real-time progress updates as the engine processes your media, identifies the fault, retrieves OEM documentation, and synthesizes a repair guide.",
